...
if monthly_payment<((annual_ir)*(initial_balance)): #prevent infinite debt loop
    print("At the rate of", str(formatted), "a month, you will never pay off that debt.")
    ...
    while balance==0:
        ...
        formatted="${0:.2f}".format(total)
        print("Total paid to date:", formatted) #consistent monthly payment + new total
        break
